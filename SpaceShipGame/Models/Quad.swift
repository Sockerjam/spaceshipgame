...
class Quad {
    ...
    init(depth: Float, device: MTLDevice?) {
        ...
        vertices = [
            Vertex(position: [-1, 1, depth], textureCoordinate: [0, 1]),
            Vertex(position: [1, 1, depth], textureCoordinate: [1, 1]),
            Vertex(position: [1, -1, depth], textureCoordinate: [1, 0]),
            Vertex(position: [-1, -1, depth], textureCoordinate: [0, 0])
        ]
